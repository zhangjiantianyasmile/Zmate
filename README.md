...
## Zmate 是什么
Zmate 是嵌在知乎使用场景里的智能伙伴：你在刷热榜、看新闻、读回答的任意时刻，都能把它唤到身边，用对话把信息变成理解。

## 为什么需要 Zmate
热点滚动太快，长文信息太密，评论区观点太杂。Zmate 不替你决定立场，而是帮你把「发生了什么、关键依据、不同看法、你可以怎么追问」说清楚，让每一次打开都更省力、更清醒。

## Zmate 能帮你做什么
* 热点速览：把当前焦点串成一条清晰时间线，抓住主线与争议点。
* 新闻解读：拆解背景与因果，用更直白的话讲清「为什么现在值得关心」。
* 文章伴读：就着眼前这篇内容追问、总结、对比观点，把阅读变成可延续的对话。


## 项目说明
**<font color=red>项目开始run之前，需要</font>**
